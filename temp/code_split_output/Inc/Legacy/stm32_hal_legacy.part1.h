...
/* DFSDM 滤波器外部触发源定义 */
#define DFSDM_FILTER_EXT_TRIG_LPTIM1               DFSDM_FILTER_EXT_TRIG_LPTIM1_OUT   // LPTIM1 输出作为 DFSDM 外部触发
#define DFSDM_FILTER_EXT_TRIG_LPTIM2               DFSDM_FILTER_EXT_TRIG_LPTIM2_OUT   // LPTIM2 输出作为 DFSDM 外部触发
#define DFSDM_FILTER_EXT_TRIG_LPTIM3               DFSDM_FILTER_EXT_TRIG_LPTIM3_OUT   // LPTIM3 输出作为 DFSDM 外部触发

/* DAC 触发源定义 */
#define DAC_TRIGGER_LP1_OUT                        DAC_TRIGGER_LPTIM1_OUT             // LPTIM1 输出作为 DAC 触发源
#define DAC_TRIGGER_LP2_OUT                        DAC_TRIGGER_LPTIM2_OUT             // LPTIM2 输出作为 DAC 触发源
...
#define TYPEERASE_PAGEERASE           FLASH_TYPEERASE_PAGES               // 页擦除（别名）
#define TYPEERASE_MASSERASE           FLASH_TYPEERASE_MASSERASE           // 全片擦除
...
/* Flash 超时时间定义 */
#define HAL_FLASH_TIMEOUT_VALUE       FLASH_TIMEOUT_VALUE                 // Flash 操作超时值
...
#define PAGESIZE                      FLASH_PAGE_SIZE                     // Flash 页面大小
...
#define VOLTAGE_RANGE_1               FLASH_VOLTAGE_RANGE_1               // 电压范围 1 (例如 2.7V-3.6V)
#define VOLTAGE_RANGE_2               FLASH_VOLTAGE_RANGE_2               // 电压范围 2
#define VOLTAGE_RANGE_3               FLASH_VOLTAGE_RANGE_3               // 电压范围 3
#define VOLTAGE_RANGE_4               FLASH_VOLTAGE_RANGE_4               // 电压范围 4 (例如 1.8V-2.1V)

/* Flash 快速编程定义 */
#define TYPEPROGRAM_FAST              FLASH_TYPEPROGRAM_FAST              // 快速编程
#define TYPEPROGRAM_FAST_AND_LAST     FLASH_TYPEPROGRAM_FAST_AND_LAST     // 快速编程并结束

/* Flash 写保护区域定义 */
#define WRPAREA_BANK1_AREAA           OB_WRPAREA_BANK1_AREAA              // Bank1 区域 A 写保护
#define WRPAREA_BANK1_AREAB           OB_WRPAREA_BANK1_AREAB              // Bank1 区域 B 写保护
#define WRPAREA_BANK2_AREAA           OB_WRPAREA_BANK2_AREAA              // Bank2 区域 A 写保护
#define WRPAREA_BANK2_AREAB           OB_WRPAREA_BANK2_AREAB              // Bank2 区域 B 写保护

/* 独立看门狗（IWDG）在低功耗模式下的行为定义 */
#define IWDG_STDBY_FREEZE             OB_IWDG_STDBY_FREEZE                // 待机模式下冻结 IWDG
#define IWDG_STDBY_ACTIVE             OB_IWDG_STDBY_RUN                   // 待机模式下 IWDG 继续运行
#define IWDG_STOP_FREEZE              OB_IWDG_STOP_FREEZE                 // 停止模式下冻结 IWDG
#define IWDG_STOP_ACTIVE              OB_IWDG_STOP_RUN                    // 停止模式下 IWDG 继续运行
...
#define FLASH_ERROR_OPTV              HAL_FLASH_ERROR_OPTV                // 选项字节有效错误
#define FLASH_ERROR_OPTVUSR           HAL_FLASH_ERROR_OPTVUSR             // 选项字节用户有效错误
...
#define FLASH_ERROR_SIZ               HAL_FLASH_ERROR_SIZE                // 大小错误（别名）
...
/* SDADC VDD 监控配置定义 */
#define OB_SDADC12_VDD_MONITOR_SET    OB_SDACD_VDD_MONITOR_SET            // 设置 SDADC VDD 监控
#define OB_SDADC12_VDD_MONITOR_RESET  OB_SDACD_VDD_MONITOR_RESET          // 复位 SDADC VDD 监控
#define IS_OB_SDADC12_VDD_MONITOR     IS_OB_SDACD_VDD_MONITOR             // 检查 SDADC VDD 监控参数

/* 读保护（RDP）等级定义 */
#define OB_RDP_LEVEL0                 OB_RDP_LEVEL_0                      // RDP 等级 0（无保护）
#define OB_RDP_LEVEL1                 OB_RDP_LEVEL_1                      // RDP 等级 1（读保护）
#define OB_RDP_LEVEL2                 OB_RDP_LEVEL_2                      // RDP 等级 2（永久保护）

/* RAM 奇偶校验配置定义 */
#define OB_RAM_PARITY_CHECK_SET       OB_SRAM_PARITY_SET                  // 使能 RAM 奇偶校验
#define OB_RAM_PARITY_CHECK_RESET     OB_SRAM_PARITY_RESET                // 禁止 RAM 奇偶校验

/* 启动锁定配置定义 */
#if defined(STM32G0) || defined(STM32C0)
#define OB_BOOT_LOCK_DISABLE          OB_BOOT_ENTRY_FORCED_NONE           // 解除启动锁定
#define OB_BOOT_LOCK_ENABLE           OB_BOOT_ENTRY_FORCED_FLASH          // 锁定从 Flash 启动
#else
#define OB_BOOT_ENTRY_FORCED_NONE     OB_BOOT_LOCK_DISABLE                // 不强制启动入口
#define OB_BOOT_ENTRY_FORCED_FLASH    OB_BOOT_LOCK_ENABLE                 // 强制从 Flash 启动
#endif

#if defined(STM32H7)
/* STM32H7 系列 Flash 标志别名 */
#define FLASH_FLAG_SNECCE_BANK1RR     FLASH_FLAG_SNECCERR_BANK1           // Bank1 单比特 ECC 错误
#define FLASH_FLAG_DBECCE_BANK1RR     FLASH_FLAG_DBECCERR_BANK1           // Bank1 双比特 ECC 错误
#define FLASH_FLAG_STRBER_BANK1R      FLASH_FLAG_STRBERR_BANK1            // Bank1 选通错误
#define FLASH_FLAG_SNECCE_BANK2RR     FLASH_FLAG_SNECCERR_BANK2           // Bank2 单比特 ECC 错误
#define FLASH_FLAG_DBECCE_BANK2RR     FLASH_FLAG_DBECCERR_BANK2           // Bank2 双比特 ECC 错误
...
#if defined(STM32U5)
/* STM32U5 系列 选项字节用户配置别名 */
#define OB_USER_nRST_STOP             OB_USER_NRST_STOP                   // 停止模式复位配置
#define OB_USER_nRST_STDBY            OB_USER_NRST_STDBY                  // 待机模式复位配置
#define OB_USER_nRST_SHDW             OB_USER_NRST_SHDW                   // 关机模式复位配置
#define OB_USER_nSWBOOT0              OB_USER_NSWBOOT0                    // 软件 BOOT0 选择
#define OB_USER_nBOOT0                OB_USER_NBOOT0                      // BOOT0 引脚配置
#define OB_nBOOT0_RESET               OB_NBOOT0_RESET                     // BOOT0 复位值
#define OB_nBOOT0_SET                 OB_NBOOT0_SET                       // BOOT0 置位值
#define OB_USER_SRAM134_RST           OB_USER_SRAM_RST                    // SRAM 复位配置
#define OB_SRAM134_RST_ERASE          OB_SRAM_RST_ERASE                   // SRAM 复位时擦除
#define OB_SRAM134_RST_NOT_ERASE      OB_SRAM_RST_NOT_ERASE               // SRAM 复位时不擦除
#endif /* STM32U5 */

#if defined(STM32U0)
/* STM32U0 系列 选项字节用户配置别名 */
#define OB_USER_nRST_STOP             OB_USER_NRST_STOP                   // 停止模式复位配置
#define OB_USER_nRST_STDBY            OB_USER_NRST_STDBY                  // 待机模式复位配置
#define OB_USER_nRST_SHDW             OB_USER_NRST_SHDW                   // 关机模式复位配置
#define OB_USER_nBOOT_SEL             OB_USER_NBOOT_SEL                   // BOOT 引脚选择
#define OB_USER_nBOOT0                OB_USER_NBOOT0                      // BOOT0 配置
#define OB_USER_nBOOT1                OB_USER_NBOOT1                      // BOOT1 配置
#define OB_nBOOT0_RESET               OB_NBOOT0_RESET                     // BOOT0 复位值
#define OB_nBOOT0_SET                 OB_NBOOT0_SET                       // BOOT0 置位值
#endif /* STM32U0 */
...
#if defined(STM32H7)
/* STM32H7 系列 JPEG 时钟与复位控制宏定义 */
#define __HAL_RCC_JPEG_CLK_ENABLE               __HAL_RCC_JPGDECEN_CLK_ENABLE        // 使能 JPEG 时钟
#define __HAL_RCC_JPEG_CLK_DISABLE              __HAL_RCC_JPGDECEN_CLK_DISABLE       // 禁止 JPEG 时钟
...
/* SYSCFG I2C 快速模式 Plus 引脚配置定义 */
#define HAL_SYSCFG_FASTMODEPLUS_I2C_PA9    I2C_FASTMODEPLUS_PA9          // PA9 引脚快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C_PA10   I2C_FASTMODEPLUS_PA10         // PA10 引脚快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C_PB6    I2C_FASTMODEPLUS_PB6          // PB6 引脚快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C_PB7    I2C_FASTMODEPLUS_PB7          // PB7 引脚快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C_PB8    I2C_FASTMODEPLUS_PB8          // PB8 引脚快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C_PB9    I2C_FASTMODEPLUS_PB9          // PB9 引脚快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C1       I2C_FASTMODEPLUS_I2C1         // I2C1 快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C2       I2C_FASTMODEPLUS_I2C2         // I2C2 快速模式 Plus
#define HAL_SYSCFG_FASTMODEPLUS_I2C3       I2C_FASTMODEPLUS_I2C3         // I2C3 快速模式 Plus

#if defined(STM32G4)
/* STM32G4 系列 IO 模拟开关配置函数别名 */
...
/* STM32H5 系列 VREFBUF 电压范围定义 */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE0   VREFBUF_VOLTAGE_SCALE0         // 电压范围 0
#define SYSCFG_VREFBUF_VOLTAGE_SCALE1   VREFBUF_VOLTAGE_SCALE1         // 电压范围 1
#define SYSCFG_VREFBUF_VOLTAGE_SCALE2   VREFBUF_VOLTAGE_SCALE2         // 电压范围 2
#define SYSCFG_VREFBUF_VOLTAGE_SCALE3   VREFBUF_VOLTAGE_SCALE3         // 电压范围 3

/* STM32H5 系列 VREFBUF 高阻抗模式定义 */
...
/* STM32H5 系列 I2C 快速模式 Plus 引脚定义 */
#define SYSCFG_FASTMODEPLUS_PB6   SBS_FASTMODEPLUS_PB6                 // PB6 快速模式 Plus
#define SYSCFG_FASTMODEPLUS_PB7   SBS_FASTMODEPLUS_PB7                 // PB7 快速模式 Plus
#define SYSCFG_FASTMODEPLUS_PB8   SBS_FASTMODEPLUS_PB8                 // PB8 快速模式 Plus
#define SYSCFG_FASTMODEPLUS_PB9   SBS_FASTMODEPLUS_PB9                 // PB9 快速模式 Plus

/* STM32H5 系列 以太网接口选择定义 */
#define SYSCFG_ETH_MII   SBS_ETH_MII                                      // 选择 MII 接口
#define SYSCFG_ETH_RMII  SBS_ETH_RMII                                     // 选择 RMII 接口
#define IS_SYSCFG_ETHERNET_CONFIG  IS_SBS_ETHERNET_CONFIG                 // 检查以太网配置参数
...
#define IS_SYSCFG_MEMORIES_ERASE_FLAG      IS_SBS_MEMORIES_ERASE_FLAG    // 检查内存擦除标志

#define IS_SYSCFG_CODE_CONFIG IS_SBS_CODE_CONFIG                          // 检查代码配置

/* STM32H5 系列 安全属性定义 */
#define SYSCFG_MPU_NSEC   SBS_MPU_NSEC                                    // MPU 非安全属性
#define SYSCFG_VTOR_NSEC  SBS_VTOR_NSEC                                   // VTOR 非安全属性

#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
/* 安全扩展定义（仅限安全状态） */
#define SYSCFG_SAU              SBS_SAU                                   // SAU 配置
#define SYSCFG_MPU_SEC          SBS_MPU_SEC                               // MPU 安全属性
#define SYSCFG_VTOR_AIRCR_SEC   SBS_VTOR_AIRCR_SEC                        // VTOR/AIRCR 安全属性
...
/* STM32H5 系列 外设 ID 定义 */
#define SYSCFG_CLK      SBS_CLK                                           // SBS 时钟
#define SYSCFG_CLASSB   SBS_CLASSB                                        // Class B
#define SYSCFG_FPU      SBS_FPU                                           // FPU
#define SYSCFG_ALL      SBS_ALL                                           // 所有

#define SYSCFG_SEC      SBS_SEC                                           // 安全属性
#define SYSCFG_NSEC     SBS_NSEC                                          // 非安全属性

/* STM32H5 系列 SYSCFG 宏定义 */
...
#define __HAL_SYSCFG_FASTMODEPLUS_ENABLE   __HAL_SBS_FASTMODEPLUS_ENABLE     // 使能快速模式 Plus
#define __HAL_SYSCFG_FASTMODEPLUS_DISABLE  __HAL_SBS_FASTMODEPLUS_DISABLE    // 禁止快速模式 Plus
...
/* STM32H5 系列 参数检查宏定义 */
#define IS_SYSCFG_FPU_INTERRUPT    IS_SBS_FPU_INTERRUPT                    // 检查 FPU 中断参数
#define IS_SYSCFG_BREAK_CONFIG     IS_SBS_BREAK_CONFIG                     // 检查断点配置参数
#define IS_SYSCFG_VREFBUF_VOLTAGE_SCALE     IS_VREFBUF_VOLTAGE_SCALE       // 检查 VREFBUF 电压范围参数
#define IS_SYSCFG_VREFBUF_HIGH_IMPEDANCE    IS_VREFBUF_HIGH_IMPEDANCE      // 检查 VREFBUF 高阻抗参数
#define IS_SYSCFG_VREFBUF_TRIMMING  IS_VREFBUF_TRIMMING                    // 检查 VREFBUF 修剪参数
#define IS_SYSCFG_FASTMODEPLUS      IS_SBS_FASTMODEPLUS                    // 检查快速模式 Plus 参数
#define IS_SYSCFG_ITEMS_ATTRIBUTES  IS_SBS_ITEMS_ATTRIBUTES                // 检查项目属性参数
#define IS_SYSCFG_ATTRIBUTES        IS_SBS_ATTRIBUTES                      // 检查属性参数
#define IS_SYSCFG_LOCK_ITEMS        IS_SBS_LOCK_ITEMS                      // 检查锁定项目参数

/* STM32H5 系列 SYSCFG 函数别名 */
...
#define HAL_SYSCFG_Lock     HAL_SBS_Lock                                             // 锁定 SBS
#define HAL_SYSCFG_GetLock  HAL_SBS_GetLock                                          // 获取锁定状态

#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define HAL_SYSCFG_ConfigAttributes     HAL_SBS_ConfigAttributes                   // 配置属性（安全状态）
#define HAL_SYSCFG_GetConfigAttributes  HAL_SBS_GetConfigAttributes                // 获取属性配置（安全状态）
#endif /* __ARM_FEATURE_CMSE */
...
#define FMC_NAND_WAIT_FEATURE_DISABLE           FMC_NAND_PCC_WAIT_FEATURE_DISABLE   // 禁止等待特性
#define FMC_NAND_WAIT_FEATURE_ENABLE            FMC_NAND_PCC_WAIT_FEATURE_ENABLE    // 使能等待特性
#define FMC_NAND_MEM_BUS_WIDTH_8                FMC_NAND_PCC_MEM_BUS_WIDTH_8        // 8位总线宽度
#define FMC_NAND_MEM_BUS_WIDTH_16               FMC_NAND_PCC_MEM_BUS_WIDTH_16       // 16位总线宽度
#endif
/**
  * @}
  */
...
#define GPIO_AF12_SDMMC                           GPIO_AF12_SDIO                    // SDMMC 复用映射到 SDIO
#define GPIO_AF12_SDMMC1                          GPIO_AF12_SDIO                    // SDMMC1 复用映射到 SDIO
#endif

#if defined(STM32F7)
/* STM32F7 系列 GPIO 复用功能定义 */
#define GPIO_AF12_SDIO                            GPIO_AF12_SDMMC1                  // SDIO 复用映射到 SDMMC1
#define GPIO_AF12_SDMMC                           GPIO_AF12_SDMMC1                  // SDMMC 复用映射到 SDMMC1
#endif
...
#define GPIO_AF7_SDIO1                            GPIO_AF7_SDMMC1                   // SDIO1 复用映射到 SDMMC1
#define GPIO_AF8_SDIO1                            GPIO_AF8_SDMMC1                   // SDIO1 复用映射到 SDMMC1
#define GPIO_AF12_SDIO1                           GPIO_AF12_SDMMC1                  // SDIO1 复用映射到 SDMMC1
#define GPIO_AF9_SDIO2                            GPIO_AF9_SDMMC2                   // SDIO2 复用映射到 SDMMC2
#define GPIO_AF10_SDIO2                           GPIO_AF10_SDMMC2                  // SDIO2 复用映射到 SDMMC2
#define GPIO_AF11_SDIO2                           GPIO_AF11_SDMMC2                  // SDIO2 复用映射到 SDMMC2

#if defined (STM32H743xx) || defined (STM32H753xx)  || defined (STM32H750xx) || defined (STM32H742xx) || \
    defined (STM32H745xx) || defined (STM32H755xx)  || defined (STM32H747xx) || defined (STM32H757xx)
/* STM32H7 特定型号 OTG 复用功能定义 */
#define GPIO_AF10_OTG2_HS  GPIO_AF10_OTG2_FS                                        // OTG2 HS 映射到 FS
#define GPIO_AF10_OTG1_FS  GPIO_AF10_OTG1_HS                                        // OTG1 FS 映射到 HS
#define GPIO_AF12_OTG2_FS  GPIO_AF12_OTG1_FS                                        // OTG2 FS 映射到 OTG1 FS
#endif /*STM32H743xx || STM32H753xx || STM32H750xx || STM32H742xx || STM32H745xx || STM32H755xx || STM32H747xx || \
         STM32H757xx */
#endif /* STM32H7 */

/* LPTIM 复用功能定义 */
#define GPIO_AF0_LPTIM                            GPIO_AF0_LPTIM1                   // LPTIM 复用功能 0 映射到 LPTIM1
#define GPIO_AF1_LPTIM                            GPIO_AF1_LPTIM1                   // LPTIM 复用功能 1 映射到 LPTIM1
#define GPIO_AF2_LPTIM                            GPIO_AF2_LPTIM1                   // LPTIM 复用功能 2 映射到 LPTIM1
...
#define  GPIO_SPEED_FAST                          GPIO_SPEED_FREQ_HIGH              // 快速（实际对应高频）
#define  GPIO_SPEED_HIGH                          GPIO_SPEED_FREQ_VERY_HIGH         // 高速（实际对应超高频）
#endif /* STM32L0 || STM32L4 || STM32F4 || STM32F2 || STM32F7 || STM32G4 || STM32H7 || STM32WB || STM32U5*/

#if defined(STM32L1)
/* STM32L1 系列 GPIO 速度模式定义 */
#define  GPIO_SPEED_VERY_LOW    GPIO_SPEED_FREQ_LOW                                 // 极低速 -> 低频
#define  GPIO_SPEED_LOW         GPIO_SPEED_FREQ_MEDIUM                              // 低速 -> 中频
#define  GPIO_SPEED_MEDIUM      GPIO_SPEED_FREQ_HIGH                                // 中速 -> 高频
#define  GPIO_SPEED_HIGH        GPIO_SPEED_FREQ_VERY_HIGH                           // 高速 -> 超高频
#endif /* STM32L1 */
